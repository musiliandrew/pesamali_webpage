    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full px-6 sm:px-8 lg:px-12 text-left pt-28 pb-16">
        <div className="max-w-lg">
          ...
          <p className="text-brand-cream/70 text-base sm:text-lg md:text-xl mb-10 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-4">
            <Link
              href="#download"
              className="inline-flex items-center gap-2 bg-brand-gold hover:bg-brand-gold-light text-brand-dark font-bold px-8 py-4 rounded-full text-lg transition-all hover:scale-105 shadow-lg shadow-brand-gold/20"
            >
              <Download size={20} />
              Download Now
            </Link>
            <Link
              href="#how-to-play"
              className="inline-flex items-center gap-2 border-2 border-brand-cream/30 hover:border-brand-gold text-brand-cream hover:text-brand-gold font-semibold px-8 py-4 rounded-full text-lg transition-all"
            >
              Learn How to Play
            </Link>
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white font-semibold px-8 py-4 rounded-full text-lg transition-all hover:scale-105 shadow-lg shadow-[#25D366]/25"
            >
              {/* WhatsApp icon */}
